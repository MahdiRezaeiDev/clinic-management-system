export function ClinicPage({ children, className = '' }) {
    return (
        <>
            ...
            <main
                dir="rtl"
                className={`clinic-page mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 ${className}`}
            >
                {children}
            </main>
        </>
...
export function ClinicPanel({
    ...
    return (
        <section
            className={`overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-100 ${className}`}
        >
            <div className="flex items-center gap-3 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-5">
                {Icon && (
...
export function ClinicStat({
    ...
    return (
        <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
            <span
                className={`absolute right-0 top-0 h-full w-1 ${palette[0]}`}
            />
            <div className="flex items-start justify-between">
                ...
                {Icon && (
                    <span
                        className={`rounded-xl p-3 ${palette[2]} ${palette[1]}`}
                    >
...
export const primaryButton =
    'inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-teal-600 to-teal-500 px-5 py-2.5 text-sm font-medium text-white shadow-lg transition hover:from-teal-700 hover:to-teal-600 hover:shadow-xl disabled:opacity-50';
