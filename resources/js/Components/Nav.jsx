...
export default function Nav({ title }) {
    ...
    return (
        <nav className="bg-blueGray-600 absolute right-0 top-0 z-10 hidden w-full items-center p-4 md:flex md:flex-row md:flex-nowrap md:justify-end print:hidden">
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Content>
                            ...
                            <ResponsiveNavLink
                                method="post"
                                href={route('logout')}
                                className="text-blueGray-700 block w-full whitespace-nowrap bg-transparent px-4 py-2 text-right text-sm font-normal"
                            >
                                خروج
                            </ResponsiveNavLink>
                        </Dropdown.Content>
