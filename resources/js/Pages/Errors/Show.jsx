...
const errors = {
    ...
    419: {
        ...
        message:
            'برای حفظ امنیت اطلاعات، لطفاً صفحه را تازه‌سازی کرده و دوباره تلاش کنید.',
        icon: Clock3,
    },
    429: {
        title: 'درخواست‌های بیش از حد',
        message:
            'تعداد درخواست‌ها زیاد بوده است؛ کمی صبر کنید و دوباره تلاش نمایید.',
        icon: Gauge,
    },
    500: {
        title: 'خطای داخلی سیستم',
        message:
            'مشکلی هنگام پردازش درخواست رخ داد. تیم فنی می‌تواند این مورد را بررسی کند.',
        icon: ServerCrash,
    },
    503: {
        title: 'سرویس موقتاً در دسترس نیست',
        message:
            'سیستم در حال نگهداری است یا موقتاً پاسخ‌گو نیست. لطفاً بعداً تلاش کنید.',
        icon: Wrench,
    },
};
