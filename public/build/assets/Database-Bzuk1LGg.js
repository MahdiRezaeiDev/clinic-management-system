import{r as n,j as e,H as l,f as i}from"./app-BVZoMc50.js";import{A as c}from"./AuthenticatedLayout-xUN8y2la.js";import"./transition-COqcsOvI.js";function p(){const[t,r]=n.useState(!1),[o,s]=n.useState(""),d=async()=>{r(!0),s("در حال شروع پشتیبان‌گیری...");try{const a=await i.post(route("backup.run"));s(a.data.message+`
