import{r as n,j as e,H as l,c}from"./app-EfKKAGlP.js";import{A as i}from"./AuthenticatedLayout-TUwCaiaC.js";import"./transition-C5RadjNG.js";function p(){const[t,r]=n.useState(!1),[o,s]=n.useState(""),d=async()=>{r(!0),s("در حال شروع پشتیبان‌گیری...");try{const a=await c.post(route("backup.run"));s(a.data.message+`
