import{r as n,j as e,H as l,c as i}from"./app-D06gZaoj.js";import{A as c}from"./AuthenticatedLayout-DCfc2lSH.js";import"./transition-gSxzY6o-.js";import"./createLucideIcon-CBuAF6E9.js";function g(){const[t,r]=n.useState(!1),[o,s]=n.useState(""),d=async()=>{r(!0),s("در حال شروع پشتیبان‌گیری...");try{const a=await i.post(route("backup.run"));s(a.data.message+`
