import{r as n,j as e,H as l,f as i}from"./app-CfO30zuv.js";import{A as c}from"./AuthenticatedLayout-BnvJUQhC.js";import"./transition-5LC-xYJu.js";function p(){const[t,r]=n.useState(!1),[o,s]=n.useState(""),d=async()=>{r(!0),s("در حال شروع پشتیبان‌گیری...");try{const a=await i.post(route("backup.run"));s(a.data.message+`
