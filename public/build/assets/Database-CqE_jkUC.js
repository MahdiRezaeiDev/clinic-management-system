import{r as n,j as e,H as l,c as i}from"./app-Bl95hy00.js";import{A as c}from"./AuthenticatedLayout-BtWiPHx6.js";import"./transition-CEhtYqw1.js";import"./createLucideIcon-C0Kytf-9.js";function g(){const[t,r]=n.useState(!1),[o,s]=n.useState(""),d=async()=>{r(!0),s("در حال شروع پشتیبان‌گیری...");try{const a=await i.post(route("backup.run"));s(a.data.message+`
